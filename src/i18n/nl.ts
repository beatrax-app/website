...
export const nl: Copy = {
  ...
  changelog: {
    ...
    statLatest: "laatste",
    filterLabel: "Filter de changelog",
    searchLabel: "Doorzoek de changelog",
    searchPlaceholder: "Zoek in alle wijzigingen…",
    showing: "{n} resultaten",
    clear: "Wis filters",
    byType: "Op type",
    byComponent: "Op onderdeel",
    noComponents: "Onderdelen worden gepubliceerd vanaf de release waarin deze afspraak landde; eerdere releases dateren van daarvoor.",
    noNotes: "Deze release is zonder notities gepubliceerd.",
    noMatches: "Niets komt overeen met deze filters.",
    viewRelease: "Bekijk deze release op GitHub",
    latest: "Laatste",
